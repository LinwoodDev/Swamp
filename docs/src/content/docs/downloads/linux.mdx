...
<TabItem label="Nightly">
  <CardGrid>
    <DownloadButton href="https://github.com/LinwoodDev/Swamp/releases/download/nightly/linwood-swamp-server-linux-x86_64.tar.gz" title="Server (x86_64)"/>
    <DownloadButton href="https://github.com/LinwoodDev/Swamp/releases/download/nightly/linwood-swamp-server-linux-arm64.tar.gz" title="Server (ARM64)"/>
  </CardGrid>
</TabItem>
</Tabs>
