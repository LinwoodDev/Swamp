---
title: Linwood Swamp
description: Universal Simple Web-Socket Application Messaging Proxy for Linwood Apps
template: splash
hero:
  tagline: Universal Simple Web-Socket Application Messaging Proxy for Linwood Apps
  image:
