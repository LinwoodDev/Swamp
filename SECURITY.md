...
Please use [the bug tracker](https://github.com/LinwoodDev/Swamp/issues) for reporting bugs. Please make sure you are on the latest stable or nightly release.

Use [security@linwood.dev](mailto:security@linwood.dev) or [the github security advisory](https://github.com/LinwoodDev/Swamp/security/advisories) if you want to report a security vulnerability.
...
Read more about nightly [here](https://swamp.linwood.dev/community/nightly).
